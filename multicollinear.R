...
set.seed(124578) #Random number protection. The set.seed is to define a clear process for the random number pick. 
bigN <- 10000
...
se_model1 <- starprep(model1, stat = c("std.error"), se_type = "HC1", alpha = 0.05) # Take model 1 and take "HC1" as the standard error and 
