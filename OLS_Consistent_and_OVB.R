...
X2 = X1 + rnorm(bigN , mean=0 , sd=2.2) #Generate X2 that is correlated to X1. We are using OVB because we know we have a correlation.
...
sd(X1)
sd(X2)
1.5 + 10*cor(X1,X2)*sd(X2)/sd(X1) #Expected value of beta1 hat
